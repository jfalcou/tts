...
/**
  ...
  behavior and assess its correctness. In **TTS**, a test case can be defined either as:
  ...
  an empty test case as erroneous in itself. **TTS** enforces a **"Empty Suite Is An Error"** rule that applies at the
  ...
  You can know use [the various **TTS** macro](usergroup2.html) to design your own unit tests.
**/
//==================================================================================================
