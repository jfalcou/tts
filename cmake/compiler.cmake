...
if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  if(CMAKE_CXX_COMPILER_FRONTEND_VARIANT STREQUAL "MSVC")
    target_compile_options( tts_test INTERFACE /W3 /EHsc /D_CRT_SECURE_NO_WARNINGS=1 /WX)
  else()
    target_compile_options( tts_test INTERFACE -Werror -Wall -Wshadow -Wextra -Wunused-variable -Wdocumentation)
  endif()
elseif (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
  target_compile_options( tts_test INTERFACE /W3 /WX /EHsc /Zc:preprocessor /wd4996)
else()
