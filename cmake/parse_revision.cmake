...
function(parse_revision version_string prefix)
  ...
  elseif("${version_string}" MATCHES ${version_regex_prerelease})
    ...
    message(STATUS "[tts] Unknown version format - Assume WIP")
...
if(GIT_EXECUTABLE)
  execute_process(COMMAND ${GIT_EXECUTABLE} describe --tags
                  ...
                  OUTPUT_VARIABLE TTS_VERSION_STRING
...
if(NOT DEFINED TTS_VERSION_STRING)
  ...
  file(READ tagname TTS_VERSION_STRING)
  string(REGEX REPLACE "[ \r\n\t]+$" "" TTS_VERSION_STRING "${TTS_VERSION_STRING}")

endif()

parse_revision("${TTS_VERSION_STRING}" TTS_VERSION)

if(TTS_VERSION_IS_WIP)
  set(tts_release "(internal version)")
else()
  if(TTS_VERSION_IS_PRERELEASE)
    set(tts_release "(pre-release)")
  endif()
endif()

message(STATUS "[tts] Configuring version ${TTS_VERSION_STRING} ${tts_release}")
